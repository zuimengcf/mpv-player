...
class PlayerPreferences(
  ...
  companion object {
    const val DEFAULT_CUSTOM_BUTTONS_JSON = """{"slots":[
      ...
      {"id":"stats-cycle","title":"监测循环","content":"mp.osd_message('监测循环',0.5) mp.commandv('script-message-to','stats','stats-cycle')","longPressContent":"mp.osd_message('监测循环',0.5) mp.commandv('script-message-to','stats','stats-cycle')","enabled":true},
      {"id":"stats-close","title":"关闭监测","content":"mp.commandv('script-message-to','stats','stats-close')","longPressContent":"mp.commandv('script-message-to','stats','stats-close')","enabled":true},
