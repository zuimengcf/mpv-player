      ...
      runCatching {
        ...
        activity.playbackStateRepository.upsert(
          PlaybackStateEntity(
            ...
            danmakuPath = activity.danmakuManager.getCurrentDanmakuPath() ?: oldState?.danmakuPath ?: "",
            danmakuTitle = activity.danmakuManager.getCurrentDanmakuTitle() ?: oldState?.danmakuTitle ?: "",
            danmakuSelected = if (activity.danmakuManager.getCurrentDanmakuPath() != null) {
              activity.danmakuManager.isTrackSelected()
            } else {
