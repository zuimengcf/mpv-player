    ...
    Column(
      ...
      Row(
        ...
        Column(modifier = Modifier.weight(1f)) {
          Text(
            text = stringResource(R.string.pref_player_custom_rewind_follow_skip_title),
            style = MaterialTheme.typography.bodyMedium
          )
          Text(
            text = stringResource(R.string.pref_player_custom_rewind_follow_skip_summary),
      ...
      if (!followSkip) {
        ...
        Column(
          ...
          Text(
            text = stringResource(R.string.pref_player_custom_rewind_duration_title),
            style = MaterialTheme.typography.bodyMedium
          )
          Text(
            text = "${duration}s",
