...
@Composable
private fun SubtitleDelaySideSheet(
  onDismissRequest: () -> Unit,
  modifier: Modifier = Modifier,
) {
  ...
  val scrimAlpha by animateFloatAsState(
    ...
    label = "sub_delay_side_sheet_scrim",
  )
...
@Composable
private fun SubtitleDelayContent(
  modifier: Modifier = Modifier,
) {
  ...
  Column(
    ...
    Column(verticalArrangement = Arrangement.spacedBy(MaterialTheme.spacing.small)) {
      ...
      OutlinedNumericChooser(
        value = delayFloat,
        onChange = { MPVLib.setPropertyDouble("sub-delay", it.toDouble()) },
        step = 0.05f,
        min = -100f,
        max = 100f,
        suffix = { Text("s") },
    ...
    Column(verticalArrangement = Arrangement.spacedBy(MaterialTheme.spacing.small)) {
      Row(
        ...
        Text(
          text = stringResource(R.string.player_sheets_sub_delay_card_speed),
          style = MaterialTheme.typography.titleMedium,
          fontWeight = FontWeight.SemiBold,
        )
      }
      ...
      OutlinedNumericChooser(
        value = speedFloat,
        onChange = { MPVLib.setPropertyDouble("sub-speed", it.toDouble()) },
        max = 10f,
        step = 0.05f,
        min = 0.1f,
        suffix = { Text("x") },
    ...
    // Subtitle Sync Calibration Card
    OutlinedCard(
      ...
      Column(
        ...
        LaunchedEffect(isDirectionPositive) {
          if (isDirectionPositive == null) {
            MPVLib.setPropertyDouble("sub-delay", finalDelay.toDouble())
        ...
        Row(
          ...
          Button(
            ...
            Text(stringResource(R.string.player_sheets_sub_delay_subtitle_voice_heard))
          }
          ...
          Button(
            ...
            Text(stringResource(R.string.player_sheets_sub_delay_subtitle_text_seen))
          }
        }
      }
    }
