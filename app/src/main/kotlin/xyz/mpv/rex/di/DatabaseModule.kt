 ...
 *
 * Adds danmakuOffset column to PlaybackStateEntity to persist danmaku time offset (milliseconds).
 */
val MIGRATION_17_18 = object : Migration(17, 18) {
  override fun migrate(db: SupportSQLiteDatabase) {
    db.execSQL("ALTER TABLE `PlaybackStateEntity` ADD COLUMN `danmakuOffset` INTEGER NOT NULL DEFAULT 0")
  }
}
